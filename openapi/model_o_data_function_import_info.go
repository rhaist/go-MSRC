...
// checks if the ODataFunctionImportInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ODataFunctionImportInfo{}
...
func NewNullableODataFunctionImportInfo(val *ODataFunctionImportInfo) *NullableODataFunctionImportInfo {
	return &NullableODataFunctionImportInfo{value: val, isSet: true}
}

...
// checks if the AffectedFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AffectedFile{}
...
func (o AffectedFile) ToMap() (map[string]interface{}, error) {

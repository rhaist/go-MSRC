...
// checks if the CvrfdocDocumentPublisherContactDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocDocumentPublisherContactDetails{}

// CvrfdocDocumentPublisherContactDetails struct for CvrfdocDocumentPublisherContactDetails
type CvrfdocDocumentPublisherContactDetails struct {
...
func NewCvrfdocDocumentPublisherContactDetails() *CvrfdocDocumentPublisherContactDetails {
	this := CvrfdocDocumentPublisherContactDetails{}
	return &this
}
...
func (o CvrfdocDocumentPublisherContactDetails) MarshalJSON() ([]byte, error) {
...
func (o CvrfdocDocumentPublisherContactDetails) ToMap() (map[string]interface{}, error) {
...
type NullableCvrfdocDocumentPublisherContactDetails struct {
	value *CvrfdocDocumentPublisherContactDetails
	isSet bool
}

func (v NullableCvrfdocDocumentPublisherContactDetails) Get() *CvrfdocDocumentPublisherContactDetails {
	return v.value
}

func (v *NullableCvrfdocDocumentPublisherContactDetails) Set(val *CvrfdocDocumentPublisherContactDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCvrfdocDocumentPublisherContactDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCvrfdocDocumentPublisherContactDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCvrfdocDocumentPublisherContactDetails(val *CvrfdocDocumentPublisherContactDetails) *NullableCvrfdocDocumentPublisherContactDetails {
	return &NullableCvrfdocDocumentPublisherContactDetails{value: val, isSet: true}
}

func (v NullableCvrfdocDocumentPublisherContactDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCvrfdocDocumentPublisherContactDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true

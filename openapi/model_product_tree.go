...
// checks if the ProductTree type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductTree{}
...
func (o ProductTree) ToMap() (map[string]interface{}, error) {

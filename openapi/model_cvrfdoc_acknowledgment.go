...
// checks if the CvrfdocAcknowledgment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocAcknowledgment{}
...
func (o CvrfdocAcknowledgment) ToMap() (map[string]interface{}, error) {

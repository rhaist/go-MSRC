...
// checks if the Cvrfdoc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Cvrfdoc{}
...
func (o Cvrfdoc) ToMap() (map[string]interface{}, error) {

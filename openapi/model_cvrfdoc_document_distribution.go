...
// checks if the CvrfdocDocumentDistribution type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocDocumentDistribution{}

// CvrfdocDocumentDistribution struct for CvrfdocDocumentDistribution
type CvrfdocDocumentDistribution struct {
...
func NewCvrfdocDocumentDistribution() *CvrfdocDocumentDistribution {
	this := CvrfdocDocumentDistribution{}
	return &this
}
...
func (o CvrfdocDocumentDistribution) MarshalJSON() ([]byte, error) {
...
func (o CvrfdocDocumentDistribution) ToMap() (map[string]interface{}, error) {
...
type NullableCvrfdocDocumentDistribution struct {
	value *CvrfdocDocumentDistribution
	isSet bool
}

func (v NullableCvrfdocDocumentDistribution) Get() *CvrfdocDocumentDistribution {
	return v.value
}

func (v *NullableCvrfdocDocumentDistribution) Set(val *CvrfdocDocumentDistribution) {
	v.value = val
	v.isSet = true
}

func (v NullableCvrfdocDocumentDistribution) IsSet() bool {
	return v.isSet
}

func (v *NullableCvrfdocDocumentDistribution) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCvrfdocDocumentDistribution(val *CvrfdocDocumentDistribution) *NullableCvrfdocDocumentDistribution {
	return &NullableCvrfdocDocumentDistribution{value: val, isSet: true}
}

func (v NullableCvrfdocDocumentDistribution) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCvrfdocDocumentDistribution) UnmarshalJSON(src []byte) error {
	v.isSet = true

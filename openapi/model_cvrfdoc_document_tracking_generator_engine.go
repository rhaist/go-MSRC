...
// checks if the CvrfdocDocumentTrackingGeneratorEngine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocDocumentTrackingGeneratorEngine{}
...
func (o CvrfdocDocumentTrackingGeneratorEngine) ToMap() (map[string]interface{}, error) {

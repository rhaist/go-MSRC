...
// checks if the CvrfdocDocumentPublisherIssuingAuthority type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocDocumentPublisherIssuingAuthority{}
...
func (o CvrfdocDocumentPublisherIssuingAuthority) ToMap() (map[string]interface{}, error) {

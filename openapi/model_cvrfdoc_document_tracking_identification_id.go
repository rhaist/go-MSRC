...
// checks if the CvrfdocDocumentTrackingIdentificationID type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocDocumentTrackingIdentificationID{}

// CvrfdocDocumentTrackingIdentificationID struct for CvrfdocDocumentTrackingIdentificationID
type CvrfdocDocumentTrackingIdentificationID struct {
...
func NewCvrfdocDocumentTrackingIdentificationID() *CvrfdocDocumentTrackingIdentificationID {
	this := CvrfdocDocumentTrackingIdentificationID{}
	return &this
}
...
func (o CvrfdocDocumentTrackingIdentificationID) ToMap() (map[string]interface{}, error) {
...
type NullableCvrfdocDocumentTrackingIdentificationID struct {
	value *CvrfdocDocumentTrackingIdentificationID
	isSet bool
}

func (v NullableCvrfdocDocumentTrackingIdentificationID) Get() *CvrfdocDocumentTrackingIdentificationID {
	return v.value
}

func (v *NullableCvrfdocDocumentTrackingIdentificationID) Set(val *CvrfdocDocumentTrackingIdentificationID) {
	v.value = val
	v.isSet = true
}

func (v NullableCvrfdocDocumentTrackingIdentificationID) IsSet() bool {
	return v.isSet
}

func (v *NullableCvrfdocDocumentTrackingIdentificationID) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCvrfdocDocumentTrackingIdentificationID(val *CvrfdocDocumentTrackingIdentificationID) *NullableCvrfdocDocumentTrackingIdentificationID {
	return &NullableCvrfdocDocumentTrackingIdentificationID{value: val, isSet: true}
}

func (v NullableCvrfdocDocumentTrackingIdentificationID) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCvrfdocDocumentTrackingIdentificationID) UnmarshalJSON(src []byte) error {
	v.isSet = true

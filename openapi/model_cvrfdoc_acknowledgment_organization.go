...
// checks if the CvrfdocAcknowledgmentOrganization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocAcknowledgmentOrganization{}

// CvrfdocAcknowledgmentOrganization struct for CvrfdocAcknowledgmentOrganization
type CvrfdocAcknowledgmentOrganization struct {
...
func NewCvrfdocAcknowledgmentOrganization() *CvrfdocAcknowledgmentOrganization {
	this := CvrfdocAcknowledgmentOrganization{}
	return &this
}
...
func (o CvrfdocAcknowledgmentOrganization) MarshalJSON() ([]byte, error) {
...
func (o CvrfdocAcknowledgmentOrganization) ToMap() (map[string]interface{}, error) {
...
type NullableCvrfdocAcknowledgmentOrganization struct {
	value *CvrfdocAcknowledgmentOrganization
	isSet bool
}

func (v NullableCvrfdocAcknowledgmentOrganization) Get() *CvrfdocAcknowledgmentOrganization {
	return v.value
}

func (v *NullableCvrfdocAcknowledgmentOrganization) Set(val *CvrfdocAcknowledgmentOrganization) {
	v.value = val
	v.isSet = true
}

func (v NullableCvrfdocAcknowledgmentOrganization) IsSet() bool {
	return v.isSet
}

func (v *NullableCvrfdocAcknowledgmentOrganization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCvrfdocAcknowledgmentOrganization(val *CvrfdocAcknowledgmentOrganization) *NullableCvrfdocAcknowledgmentOrganization {
	return &NullableCvrfdocAcknowledgmentOrganization{value: val, isSet: true}
}

func (v NullableCvrfdocAcknowledgmentOrganization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCvrfdocAcknowledgmentOrganization) UnmarshalJSON(src []byte) error {
	v.isSet = true

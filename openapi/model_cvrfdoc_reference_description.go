...
// checks if the CvrfdocReferenceDescription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocReferenceDescription{}
...
func (o CvrfdocReferenceDescription) ToMap() (map[string]interface{}, error) {

...
func NewCvrfdocDocumentTrackingRevisionDescription() *CvrfdocDocumentTrackingRevisionDescription {
	this := CvrfdocDocumentTrackingRevisionDescription{}
	return &this
}
...
type NullableCvrfdocDocumentTrackingRevisionDescription struct {
	value *CvrfdocDocumentTrackingRevisionDescription
	isSet bool
}

func (v NullableCvrfdocDocumentTrackingRevisionDescription) Get() *CvrfdocDocumentTrackingRevisionDescription {
	return v.value
}

func (v *NullableCvrfdocDocumentTrackingRevisionDescription) Set(val *CvrfdocDocumentTrackingRevisionDescription) {
	v.value = val
	v.isSet = true
}

func (v NullableCvrfdocDocumentTrackingRevisionDescription) IsSet() bool {
	return v.isSet
}

func (v *NullableCvrfdocDocumentTrackingRevisionDescription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCvrfdocDocumentTrackingRevisionDescription(val *CvrfdocDocumentTrackingRevisionDescription) *NullableCvrfdocDocumentTrackingRevisionDescription {
	return &NullableCvrfdocDocumentTrackingRevisionDescription{value: val, isSet: true}
}

func (v NullableCvrfdocDocumentTrackingRevisionDescription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCvrfdocDocumentTrackingRevisionDescription) UnmarshalJSON(src []byte) error {
	v.isSet = true

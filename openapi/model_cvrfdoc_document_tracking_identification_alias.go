...
// checks if the CvrfdocDocumentTrackingIdentificationAlias type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocDocumentTrackingIdentificationAlias{}
...
func (o CvrfdocDocumentTrackingIdentificationAlias) ToMap() (map[string]interface{}, error) {

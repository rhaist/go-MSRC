...
// checks if the CvrfdocDocumentTitle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvrfdocDocumentTitle{}
...
func (o CvrfdocDocumentTitle) ToMap() (map[string]interface{}, error) {
